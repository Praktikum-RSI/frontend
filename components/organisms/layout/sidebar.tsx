...
export function Sidebar() {
  ...
  return (
    <aside className="w-56 border-r border-sidebar-border bg-sidebar">
      <div className="p-6">
        <h2 className="text-sm font-bold uppercase tracking-wider text-sidebar-foreground/70">Admin Panel</h2>
        <p className="text-xs uppercase tracking-widest text-sidebar-foreground/50 mt-1">EVENT MANAGEMENT</p>
      </div>
